...
export class EditDocumentComponent implements OnInit {
  ...
  @Input() documentId: string = "8cfabead-ab42-4d37-9766-e60e6b7cca6b"
  ...
  constructor(private markerSerivce: MarkerService, private notifications: NotificationService) {
  ...
  freeDraw(evt): void {
    ...
    console.log(ctx1.isPointInPath(evt.clientX,evt.clientY))
  ...
  ngAfterViewInit() {
    ...
    base_image.src = 'assets/ModelDiagram.png';
